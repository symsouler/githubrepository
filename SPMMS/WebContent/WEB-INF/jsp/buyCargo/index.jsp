	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td><font style="font-size: 14px;"><strong>位置：</strong>首页&gt;超市信息管理&gt;进货管理&gt;进货信息</font></td>
			</tr>
		</table>
		</td>
	</tr>
							...
							<thead>
								...
								<tr>
									...
									<td class="box_table_odd">
										<input type="text" id="startTime" class="time"/> 
										<img src="images/ksjl.jpg" width="25" height="21" align="absmiddle" /> 
										<input type="text" id="endTime" class="time"/>
										<img src="images/ksjl.jpg" width="25" height="21" align="absmiddle" />
									</td>
							...
							<tr>
								<td height="26" align="right">
									<span class="font_right">
										...
										<%--<input type="button" value="导出" onclick="window.location.href='operationLog/exportExcel.action';"/>--%>
